...
=============================================================================
목적: 50,000명의 유저에 대한 4개 테이블(user_profile, login_logs,
      package_purchase, trade_market)을 설계서 기반으로 생성

핵심 설계 원칙:
  - 0%, 100% 같은 극단값 절대 배제
  - 10~100조 그룹이 패키지 출시에 가장 민감하게 반응
  - 패키지 출시일: 1/18, 2/20, 3/20
  - 이탈 정의: 최종 로그인 후 30일 미접속
  - 그룹별 OVR 평균: 0~10조=130.9, 10~100조=133.4, 100~1000조=136.1, 1000조이상=137.3
  - 구단가치 하락률 (10~100조가 최대): 설계서 표 참조

참고: 데이터 분석 설계서(FC온라인4), 가안(2), 샘플데이터_생성 노트북
=============================================================================
"""
